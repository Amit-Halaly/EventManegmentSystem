...
void freeInvoiceArr(Invoice** arr, int size)
{
    generalArrayFunction(arr, size, sizeof(Event*), freeInvoicePtr);
}

void freeAcountent(Acountent* a)
{
    freeInvoiceArr(a->invoices, a->NOfInvoices);
    free(a->invoices);
}
